 ...
 * generated in the com.ws.trainings package. 
...
public class ObjectFactory {
    ...
    private final static QName _CreateOrdersRequest_QNAME = new QName("http://trainings.ws.com", "createOrdersRequest");
    private final static QName _CreateOrdersResponse_QNAME = new QName("http://trainings.ws.com", "createOrdersResponse");
    private final static QName _DeleteOrdersRequest_QNAME = new QName("http://trainings.ws.com", "deleteOrdersRequest");
    private final static QName _DeleteOrdersResponse_QNAME = new QName("http://trainings.ws.com", "deleteOrdersResponse");
    private final static QName _GetOrdersRequest_QNAME = new QName("http://trainings.ws.com", "getOrdersRequest");
    private final static QName _GetOrdersResponse_QNAME = new QName("http://trainings.ws.com", "getOrdersResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ws.trainings
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://trainings.ws.com", name = "createOrdersRequest")
     ...
     */
    @XmlElementDecl(namespace = "http://trainings.ws.com", name = "createOrdersResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://trainings.ws.com", name = "deleteOrdersRequest")
     ...
     */
    @XmlElementDecl(namespace = "http://trainings.ws.com", name = "deleteOrdersResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://trainings.ws.com", name = "getOrdersRequest")
     ...
     */
    @XmlElementDecl(namespace = "http://trainings.ws.com", name = "getOrdersResponse")
